            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <fieldset class="col-md-12">
                        <legend class="row"><i class="fa fa-list"></i>Requerimentos Deferidos Parcialmente
                ...
                <div class="ibox-content">
                    <table class="table">
                        ...
                        <tbody>
                        <tr v-for="( req, index ) in parcialmente">
                            <td>{{ index + 1 }}</td>
                            <td>{{req.protocolo}}</td>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                pagination:{},
                pageHeading: {
                    title: 'Requerimentos Deferidos Parcialmente',
                    fa: 'fa fa-thumbs-up',
                    breadcrumb: [
        ...
        methods: {
            load(){
                ...
                Sg.get(laroute.route('get-requerimentos-deferidos-parcialmente'))
                    .then((response) => {
                        this.parcialmente = response.data;
            ...
            navigate(page){
                console.log(page);
                Sg.get(laroute.route('get-requerimentos-deferidos-parcialmente', {page: page}))
                    .then((response) => {
                        this.parcialmente = response.data;
                        this.pagination = response;
                    });
