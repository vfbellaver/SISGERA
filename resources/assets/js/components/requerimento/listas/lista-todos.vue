            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <fieldset class="col-md-12">
                        <legend class="row"><i class="fa fa-list"></i>  Todos Requerimentos
    ...
    export default {
        ...
        methods: {
            load(){
                ...
                Sg.get(laroute.route('get-requerimentos-todos'))
                    .then((response) => {
            ...
            navigate(page){
                console.log(page);
                Sg.get(laroute.route('get-requerimentos-todos', {page: page}))
                    .then((response) => {
                        this.list = response.data;
                        this.pagination = response;
                    });
