            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <table class="table table-responsive">
                        ...
                        <tbody>
                        <tr v-for="( req, index ) in defparcialmente">
                            <td>{{ index + 1 }}</td>
                            <td>{{req.protocolo}}</td>
    ...
    export default {
        ...
        data() {
            return {
                ...
                pagination: {},
                pageHeading: {
                    title: 'Requerimentos Deferidos Parcilamente',
                    fa: 'fa fa-thumbs-up',
                    breadcrumb: [
        ...
        methods: {
            load(){
                Sg.get(laroute.route('meus-req-deferidos-parcialmente'))
                    .then((response) => {
                        this.defparcialmente = response.data;
            ...
            navigate(page){
                console.log(page);
                Sg.get(laroute.route('meus-req-deferidos-parcialmente', {page: page}))
                    .then((response) => {
                        this.defparcialmente = response.data;
                        this.pagination = response;
                    });
