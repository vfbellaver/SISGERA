    ...
    export default {
        ...
        data() {
            return {
                ...
                pagination: {},
                pageHeading: {
                    title: 'Deferidos Parcialmente Cerel',
                    fa: 'fa fa-refresh',
                    breadcrumb: [
        ...
        methods: {
            load(){
                Sg.get(laroute.route('get-conta-requerimentos-deferidos-parcialmente'))
                    .then((response) => {
            ...
            navigate(page){
                console.log(page);
                Sg.get(laroute.route('get-conta-requerimentos-deferidos-parcialmente', {page: page}))
                    .then((response) => {
                        this.reqandamento = response.data;
                        this.pagination = response;
                    });
