    ...
    export default {
        ...
        data() {
            return {
                ...
                pagination: {},
                pageHeading: {
                    title: 'Indeferidos '+Sisgera.user.conta.name,
        ...
        methods: {
            load(){
                Sg.get(laroute.route('get-conta-requerimentos-indeferidos'))
                    .then((response) => {
            ...
            navigate(page){
                console.log(page);
                Sg.get(laroute.route('get-conta-requerimentos-indeferidos', {page: page}))
                    .then((response) => {
                        this.reqandamento = response.data;
                        this.pagination = response;
                    });
